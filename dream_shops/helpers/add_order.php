        ...
        //GENERATE A RANDOM INVOICE NUMBER
          ...
          if($rows == 1 ) {
            ...
            SET `fullname`='$fullname', `phone`='$phone',
                ...
                `zip`='$zip', `email`='$email', `items`='$items',`payment_type`='0' WHERE id = '$id'  ";
            ...
            $sql = "INSERT INTO `orders` (`id`, `cart_id`, `fullname`, `phone`, `province`, `city`, `address`, `zip`, `email`, `items`, `invoice`, `paid`)
            VALUES (NULL, '$cart_id', '$fullname', '$phone', '$province', '$city', '$address', '$zip', '$email', '$items', '$invoice', '0')";
